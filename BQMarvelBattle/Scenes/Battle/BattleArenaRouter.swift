...
@objc protocol BattleArenaRoutingLogic
{
...
class BattleArenaRouter: NSObject, BattleArenaRoutingLogic, BattleArenaDataPassing
{
  ...
  //func navigateToSomewhere(source: BattleArenaViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: BattleArenaDataStore, destination: inout SomewhereDataStore)
  //{
